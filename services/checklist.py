...
@enforce_schema
def generate(status: str = STATUS_UNREGISTERED, first_time: bool = False) -> dict:
    """
    Generate a personalized voter checklist based on registration status.

    Args:
        status: "unregistered", "registered", or "returning"
        first_time: Whether user is a first-time voter

    Returns:
        build_response() with ordered checklist steps
    """
