...
INDIA_MOCK_DATA = {
    ...
    "tn_parties_2026": [
        {"name": "DMK",    "full": "Dravida Munnetra Kazhagam",              "alliance": "INDIA Alliance"},
        {"name": "AIADMK", "full": "All India Anna Dravida Munnetra Kazhagam","alliance": "Independent"},
        {"name": "BJP",    "full": "Bharatiya Janata Party",                 "alliance": "NDA"},
        {"name": "INC",    "full": "Indian National Congress",               "alliance": "INDIA Alliance"},
        {"name": "VCK",    "full": "Viduthalai Chiruthaigal Katchi",         "alliance": "INDIA Alliance"},
        {"name": "PMK",    "full": "Pattali Makkal Katchi",                  "alliance": "NDA"},
        {"name": "MDMK",   "full": "Marumalarchi Dravida Munnetra Kazhagam", "alliance": "INDIA Alliance"},
        {"name": "TVK",    "full": "Tamilaga Vettri Kazhagam (Vijay Party)", "alliance": "INDIA Alliance"},
        {"name": "DMDK",   "full": "Desiya Murpokku Dravida Kazhagam",       "alliance": "NDA"},
        {"name": "CPI(M)", "full": "Communist Party of India (Marxist)",     "alliance": "INDIA Alliance"},
    ],
    # Tamil Nadu Vidhan Sabha 2026 — single-phase state election
    "election_phases": [
        {"phase": "Single Phase", "date": "April 23, 2026", "states": "Entire Tamil Nadu (234 constituencies)"},
    ],
    "registration_info": {
    ...
    "id_types_accepted": [
        ...
        "NPR Smart Card", "MNREGA Job Card", "Pension Documents with photo",
        "Service Identity Card (Govt employees)", "Health Insurance Smart Card",
        "Passbook with photo (Banks/Post Office)", "Student ID with photo"
    ],
    "next_election": {
...
@enforce_schema
def get_india_election_info(state: str = None) -> dict:
    """
...
def get_india_eligibility_info() -> dict:
